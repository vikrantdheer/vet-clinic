...
public class WhenWorkingWithAPetMap {
	...
	public void should_be_able_to_get_a_default_value_if_no_matching_key_is_present() {
		...
		Pet defaultPet = Pet.parrot().named("Parrot");
		...
		Pet defaultPetResult = pets.getOrDefault("Vikrant", defaultPet);

		assertThat(defaultPetResult, equalTo(defaultPet));
	}
	...
	public void the_map_keys_should_be_the_pet_names() {
		...
		assertThat(pets.keySet(), containsInAnyOrder("Felix","Fido"));
