...
public class WhenCreatingAComplexEnum {
	...
	/**
	 * Add the scientific name to the animal breeds. Cat = "Felis catus" Dog =
	 * "Canis lupus familiaris" Rabbit = "Oryctolagus cuniculus" Fish =
	 * "Carassius auratus" Parrot = "Psittaciformes"
	 */
	@Test
	public void should_be_able_to_find_the_scientific_names_of_an_animal_breed() {

		// TODO: Refactor the Breed enum so that it also stores the scientific
